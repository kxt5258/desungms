...
//Custom Settings
globalValues {
	app.fullname = "De-suung Management Information System" //Application Full Name
	app.logo ="desuung_logo.jpg"
	app.url = "http://localhost:8080/${appName}"
	app.dzongkhags = ["Thimphu","Bumthang", "Chukha", "Dagana","Gasa","Haa","Lhuentse","Mongar",
	...
	app.bloodGroups = ['O+','O-','A+','A-','B+','B-','AB+','AB-',' ']
	app.livingStatus = ["Alive","Dead"]
}
...
environments {
    ...
    production {
		...
		//grails.serverURL = "http://www.something.com/${appName}"
    }
}
