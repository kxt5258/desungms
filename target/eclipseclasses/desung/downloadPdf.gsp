...
<html>
	...
	<h2>Details of ${desungInstance?.name} (De-suung ID: ${desungInstance?.desungId})</h2><br />
<table class="desupdetail" WIDTH=100%>
				...
				<td rowspan="8">
						<bi:hasImage bean="${desungInstance}">
							<img class="profilepdf" src="${grailsApplication.config.globalValues.app.url}/images/${imageId.toString()}-large.png" />		
						</bi:hasImage>						
					</td>
				</tr>
				</g:if>
				...
				<td>
						<span class="property-value" aria-labelledby="gender-label"><g:fieldValue bean="${desungInstance}" field="qualification"/></span>
				</td>
				</tr>
				</g:if>
